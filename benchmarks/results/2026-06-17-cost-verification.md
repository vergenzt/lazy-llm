...
Context: the README headline says lazy is "47-77% cheaper." This is a fresh
...
- On Claude, lazy is **42-75% cheaper** than no-skill across Haiku, Sonnet, and Opus
...
- Correctness is not hurt anywhere: lazy scores **100%** on every Claude and OpenAI
...
Three arms (no skill, caveman, lazy) on Claude; baseline vs lazy on OpenAI. Five
...
The reasoning models (gpt-5.4-mini, gpt-5.5) cost more under tech debt: the ruleset is
...
gemini-3.1-pro-preview (top), baseline vs lazy.
...
models, including the newest top model gpt-5.5, lazy costs more, not less. The number is
